    ...
    if (validateForm()) {
      ...
      await axios
        ...
        .then((res) => {
          ...
          if (formData.email === "admin@gmail.com") navigate("/admin");
          else navigate("/");
      ...
      <div className="sign-in d-flex flex-column align-items-center">
        ...
        <div className="content mb-3">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {errors.email && (
              <div className="error-text m-4 mt-2 mb-2">{errors.email}</div>
            )}
            <div className="field">
              <input
            ...
            {errors.password && (
              <div className="error-text m-4 mt-2 mb-2">{errors.password}</div>
            )}
