      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-4 col-md-4 col-sm-12 d-flex flex-column justify-content-center align-items-center ">
            ...
            <div className="copyright fw-lighter">
          ...
          <div className="col-lg-4 col-md-3 col-sm-12 d-flex flex-column justify-content-end align-items-center">
            <div className="footer-right d-flex flex-column justify-content-end align-items-center" >
              <div className="fw-lighter follow-us mt-lg-0 mt-md-0 mt-sm-4">Follow Us On</div>
              
              <div className="card1 mt-4  d-flex  justify-content-center  ">
