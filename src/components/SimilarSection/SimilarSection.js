...
const SimilarSection = () => {
  ...
  return (
    <div className="similar-section">
      ...
      <div className="container similar p-0 d-flex flex-column justify-content-center">
        ...
        <React.Fragment key={index}>
          <div className="img d-flex justify-content-start">
            <img
              ...
              alt={`${index + 1}`}
            />
            <div className="ep-number d-flex flex-column justify-content-center">
              <span>poldark poldark</span>
              <span>2014 </span>
            </div>
          </div>
